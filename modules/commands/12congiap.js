...
module.exports.onLoad = () => {
  ...
  if (!fs.existsSync(dirMaterial + "sửu.jpg")) request("https://i.imgur.com/11RFXQx.jpg").pipe(fs.createWriteStream(dirMaterial + "sửu.jpg"));
  
  if (!fs.existsSync(dirMaterial + "tý.jpg")) request("https://i.imgur.com/5HxGOz7.jpg").pipe(fs.createWriteStream(dirMaterial + "tý.jpg"));
  
  if (!fs.existsSync(dirMaterial + "dần.jpg")) request("https://i.imgur.com/gSzX7nL.jpg").pipe(fs.createWriteStream(dirMaterial + "dần.jpg"));
  
  if (!fs.existsSync(dirMaterial + "mão.jpg")) request("https://i.imgur.com/SVcdKJp.jpg").pipe(fs.createWriteStream(dirMaterial + "mão.jpg"));
  
  if (!fs.existsSync(dirMaterial + "thìn.jpg")) request("https://i.imgur.com/ANdQTeq.jpg").pipe(fs.createWriteStream(dirMaterial + "thìn.jpg"));
  
  if (!fs.existsSync(dirMaterial + "tỵ.jpg")) request("https://i.imgur.com/lnxS2Xr.jpg").pipe(fs.createWriteStream(dirMaterial + "tỵ.jpg"));
  
  if (!fs.existsSync(dirMaterial + "ngọ.jpg")) request("https://i.imgur.com/FnKVUKI.jpg").pipe(fs.createWriteStream(dirMaterial + "ngọ.jpg"));
  
  if (!fs.existsSync(dirMaterial + "mùi.jpg")) request("https://i.imgur.com/fOSI3wz.jpg").pipe(fs.createWriteStream(dirMaterial + "mùi.jpg"));
  
  if (!fs.existsSync(dirMaterial + "thân.jpg")) request("https://i.imgur.com/hPTcpV5.jpg").pipe(fs.createWriteStream(dirMaterial + "thân.jpg"));
  
  if (!fs.existsSync(dirMaterial + "dậu.jpg")) request("https://i.imgur.com/chW3Tc1.jpg").pipe(fs.createWriteStream(dirMaterial + "dậu.jpg"));

  if (!fs.existsSync(dirMaterial + "tuất.jpg")) request("https://i.imgur.com/7i7GU1t.jpg").pipe(fs.createWriteStream(dirMaterial + "tuất.jpg"));

  if (!fs.existsSync(dirMaterial + "hợi.jpg")) request("https://i.imgur.com/hJ5nfUa.jpg").pipe(fs.createWriteStream(dirMaterial + "hợi.jpg"));
