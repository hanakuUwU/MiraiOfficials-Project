...
var time= moment.tz("Asia/Ho_Chi_Minh").format("DD/MM/YYYY || HH:mm:s");
    ...
    return console.log(chalk.hex("#" + randomColor)(`◆━━━━━━━━━━◆━━━━━━━━━◆◆━━━━━━━━◆━━━━━━━━━━◆\n ${threadName} `) + chalk.hex("#" + randomColor)(`|`) +chalk.hex("#" + randomColor1) (` ${name} \n`) + chalk.hex("#" + randomColor)(`|`) + chalk.hex("#" + randomColor2)(` Text: ${msg} `) + chalk.hex("#" + randomColor) (`|`) + chalk.hex("#" + randomColor3)(`\n[ ${textt} ${time} ]`) );
}
}
